...
export default function TerminalPreview({
  ...
  useEffect(() => {
    ...
    terminal.write(
      "\x1b[?25l\x1b[1;32myou@server\x1b[0m:\x1b[1;34m~/projects\x1b[0m $ git status\r\n\x1b[32m✓ Connected\x1b[0m  \x1b[33m● Warning\x1b[0m  \x1b[31m✕ Error\x1b[0m\r\n",
    );
    for (let row = 0; row < 2; row++) {
      for (let color = 0; color < 8; color++)
        terminal.write(
          `\x1b[${(row ? 90 : 30) + color}m ANSI ${color + row * 8} \x1b[0m`,
        );
      terminal.write("\r\n");
    }
  ...
  return (
    <div
      ...
      aria-label={tr("Live terminal color preview")}
      ref={container}
